...
>(
  (
    ...
    return (
      ...
      >
        {/* Sidebar gap for layout alignment */}
        <div
          className={cn(
        ...
        <div
          className={cn(
            ...
            side === "left"
              ? "left-0"
              : "right-0",
            // Remove border classes for seamless look
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]: md:peer-data-[variant=inset]:shadow",
        className
      )}
      {...props}
    />
